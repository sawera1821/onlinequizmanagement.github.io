<%@ Page Title="Advance Quiz" Language="C#" MasterPageFile="~/quizmaster.Master" AutoEventWireup="true" CodeBehind="Advancequiz.aspx.cs" Inherits="Wpltheoryfinalproject.Advancequiz" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Button ID="checkans" runat="server" Text="Check Answers" CssClass="auto-style3" OnClick="checkans_Click" class="btn btn-dark" Height="40px" Width="144px" BackColor="Black" Font-Bold="True" Font-Size="Large" ForeColor="White"  OnClientClick="ToggleDiv('first');return false;"/>
    
    <asp:Button ID="back" runat="server" Text="Back" CssClass="auto-style3" class="btn btn-dark" Height="40px" Width="144px" BackColor="Black" Font-Bold="True" Font-Size="Large" ForeColor="White"  OnClientClick="ToggleDiv('first');return false;" OnClick="back_Click"/>
    <br />
    <div id="showans">
<asp:GridView ID="grid1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="49px" OnSelectedIndexChanged="grid1_SelectedIndexChanged"  >  
